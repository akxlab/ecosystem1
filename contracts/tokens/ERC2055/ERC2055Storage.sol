...
abstract contract ERC2055Storage {
    ...
    mapping(address => mapping(uint256 => Balances[])) private _tokenBalances;
    ...
    mapping(uint256 => bool) private _hasMetas;
    mapping(uint256 => IERC2055) private _underlyings;
    ...
    function decimal(uint256 tokenId) external view returns (uint8) {
