...
export interface EIP1155UStorageInterface extends utils.Interface {
  functions: {
    ...
    "resolverAddress()": FunctionFragment;
...
export interface EIP1155UStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EIP1155UStorageInterface;
  ...
  functions: {
    ...
    resolverAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    resolverAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    resolverAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
